# Ingest report, bn (Claude review at the founder's decision (native review owed post-launch), 2026-08-07)

Rows 60, agreements 44, defects 16 (0 blocking), unsure keeps 0, starred for tone 5.

## Defects, each needing a founder-approved resolution

### bn-01: RECALL: the reviewer says this is an order, the guard keeps it

> এতে একটি উত্তর দরকার হতে পারে. নিশ্চিত হতে মূল ডকুমেন্টে বা প্রেরকের কাছে যাচাই করুন.

- [x] RESOLVED: Keep at the English mirror: Northcue's own check line. The mirror sentence was run through the English stack during this ingest and is KEPT, so parity says the vocabulary is right to keep the translation; catching it would strip sentences an English reader keeps (hi-42 and ro-31 precedents).
...
### bn-07: RECALL: the reviewer says this is an order, the guard keeps it

> নবায়ন শর্তাবলী যাচাই করুন এবং প্রয়োজনে 1 August 2026 এর আগে যোগাযোগ করুন।

- [x] RESOLVED: Keep at the English mirror: Northcue's own check line. The mirror sentence was run through the English stack during this ingest and is KEPT, so parity says the vocabulary is right to keep the translation; catching it would strip sentences an English reader keeps (hi-42 and ro-31 precedents).
  Approved: Founder, 7 August 2026, wave-two complete seven-language ingest instruction: packs Claude-reviewed at the founder's decision, expected keeps resolved at the English mirror per the hi-42 and ro-31 precedents, named defects traced with fix-or-record orders.

### bn-09: RECALL: the reviewer says this is an order, the guard keeps it
...
> যা করতে হবে তা দেখুন।

- [x] RESOLVED: Keep at the English mirror: Northcue's own navigation line. The mirror sentence was run through the English stack during this ingest and is KEPT, so parity says the vocabulary is right to keep the translation; catching it would strip sentences an English reader keeps (hi-42 and ro-31 precedents).
  Approved: Founder, 7 August 2026, wave-two complete seven-language ingest instruction: packs Claude-reviewed at the founder's decision, expected keeps resolved at the English mirror per the hi-42 and ro-31 precedents, named defects traced with fix-or-record orders.

### bn-21: RECALL: the reviewer says this is an order, the guard keeps it
...
- bn-36: পরিচয় নিশ্চিত করা আবশ্যক না হলে দাবি প্রক্রিয়া বন্ধ হতে পারে।
- bn-37: একক ব্যক্তি ছাড় ২৫% (£460.50) বাদ দিয়ে দিতে হবে £1,381.50।
- bn-45: মোট দিতে হবে £1,381.50।
- bn-52: বকেয়া 12 সেপ্টেম্বর 2026 তারিখের মধ্যে মেটাতে হবে।
