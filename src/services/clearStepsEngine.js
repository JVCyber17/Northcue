...
const DECISIVE_SCAM_CHECKS_I18N = {
  ...
  es: [
    ["contraseña completa", "Asks for a full password, which real organisations never request."],
    ["confirmar su contraseña", "Asks you to confirm a password."],
    ["confirme su contraseña", "Asks you to confirm a password."],
    ["introducir su contraseña", "Asks you to enter a password."],
    ["introduzca su contraseña", "Asks you to enter a password."],
    ["confirmar su pin", "Asks you to confirm a PIN."],
    ["confirme su pin", "Asks you to confirm a PIN."],
    ["número de tarjeta y pin", "Asks for card number and PIN together."],
    ["número de tarjeta, pin", "Asks for card number and PIN together."],
  ...
  pt: [
    ["senha completa", "Asks for a full password, which real organisations never request."],
    ["palavra-passe completa", "Asks for a full password, which real organisations never request."],
    ["confirmar a sua senha", "Asks you to confirm a password."],
    ["confirme a sua senha", "Asks you to confirm a password."],
    ["introduzir a sua senha", "Asks you to enter a password."],
    ["insira a sua senha", "Asks you to enter a password."],
    ["confirmar o seu pin", "Asks you to confirm a PIN."],
    ["confirme o seu pin", "Asks you to confirm a PIN."],
    ["número do cartão e pin", "Asks for card number and PIN together."],
    ["cartão presente", "Mentions gift card payment."],
  ...
  pa: [
    ["ਪੂਰਾ ਪਾਸਵਰਡ", "Asks for a full password, which real organisations never request."],
    ["ਪਾਸਵਰਡ ਦੀ ਪੁਸ਼ਟੀ", "Asks you to confirm a password."],
    ["ਪਾਸਵਰਡ ਦਰਜ", "Asks you to enter a password."],
    ["ਪਿੰਨ ਦੀ ਪੁਸ਼ਟੀ", "Asks you to confirm a PIN."],
    ["ਕਾਰਡ ਨੰਬਰ ਅਤੇ ਪਿੰਨ", "Asks for card number and PIN together."],
    ["ਗਿਫਟ ਕਾਰਡ", "Mentions gift card payment."],
    ["ਖਾਤਾ ਮੁਅੱਤਲ", "Threatens to suspend your account within a short time."],
    ["ਖਾਤਾ ਬਲਾਕ", "Threatens to suspend your account within a short time."]
  ]
};
